...
integer*4                       :: ind_cent,lon_cent,lat_cent,patch_size,patch_side,i,j,k,countnum,patch_nums,countR,interval,valmode
...
do ind_cent = 1,ind
    ...
    !lat_cent = 800
        ...
        if (ovs==0) then
            ...
            j=1
            xf=0
            errfix=sqrt(0.02*sum(xt)/size(xt))  ! A. Annis et al 2022
