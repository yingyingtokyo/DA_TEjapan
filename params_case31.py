...
# *************************************************************
def def_params():
    pm_line = 'import params_all_case3 as pm\n'
...
def starttime(DAhour=DA_leading()):
    #if DAhour == 'on':
        return (2024,8,15,0) # start date: [year,month,date]
...
def endtime(DAhour=DA_leading()):
    #if DAhour == 'on':
        return (2024,8,23,0) # end date: [year,month,date]
...
def outdir():
    if (val_mode()==0):
        return '/data50/yingying/HydroDA/out_all3/'
    else:
        return '/data50/yingying/HydroDA/out_case3_round'+ str(val_round(val_mode())) +'/'

def expout():
    if (val_mode()==0):
        return '../out_all3/'
    else:
        return '../out_case3_round'+ str(val_round(val_mode())) +'/'
