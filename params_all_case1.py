...
# *************************************************************
def def_params():
    pm_line = 'import params_all_case1 as pm\n'
...
def flood_reg():
    ...
    # case2 Akita event: 38.73-40.51; 139.666-140.9
    ### return [lat_min,lat_max,lon_min,lon_max]
    return [37.52,41.24,138.64,141.5]
    # return [35.99,41.24,136.01,141.5]
...
def starttime(DAhour=DA_leading()):
    if DAhour == 'on':
        return (2022,8,3,0) # start date: [year,month,date]
    else:
        return (2022,8,1,0)

def endtime(DAhour=DA_leading()):
    if DAhour == 'on':
        return (2022,8,4,0) # end date: [year,month,date]
    else:
        return (2022,8,6,0)  # *note: this date is not included
...
def outdir():
    if (val_mode()==0):
        return '/data50/yingying/HydroDA/out_all1/'
    else:
        return '/data50/yingying/HydroDA/out_case1_round'+ str(val_round(val_mode())) +'/'

def expout():
    if (val_mode()==0):
        return '../out_all1/'
    else:
        return '../out_case1_round'+ str(val_round(val_mode())) +'/'
