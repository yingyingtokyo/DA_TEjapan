...
# *************************************************************
def def_params():
    pm_line = 'import params_case14 as pm\n'
...
def starttime(DAhour=DA_leading()):
    if DAhour == 'on':
        return (2025,1,1,0) # start date: [year,month,date]
    else:
        return (2025,1,1,0)

def endtime(DAhour=DA_leading()):
    if DAhour == 'on':
        return (2025,9,1,0) # end date: [year,month,date]
    else:
        return (2025,9,1,0)  # *note: this date is not included
