...
# *************************************************************
def def_params():
    pm_line = 'import params_river01 as pm\n'
...
def val_mode():
    ...
    return 6  # turn off validation mode but only simulate upstream
...
def outdir():
    if (val_mode()==0):
        return '/data50/yingying/HydroDA/out_all/'
    elif (val_mode()==6):
        return '/data50/yingying/HydroDA/out_all_river'+ str(val_round(val_mode())) +'/'
    else:
        return '/data50/yingying/HydroDA/out_ils_round'+ str(val_round(val_mode())) +'/'

def expout():
    if (val_mode()==0):
        return '../out_all/'
    elif (val_mode()==6):
        return '../out_all_river'+ str(val_round(val_mode())) +'/'
    else:
        return '../out_ils_round'+ str(val_round(val_mode())) +'/'
