...
# *************************************************************
def def_params():
    pm_line = 'import params_patch07 as pm\n'
    def replace_as_pm_line(target_file):
        ...
        for line in target_lines:
            if 'as pm' in line and 'pm_line' not in line:
...
def patch_dir():
    return "/data42/yingying/HydroDA/obs_patch0"+str(int(thersold()*100))

def patch_filedir():
    os.makedirs("/data42/yingying/HydroDA/obs_patch/obs_patch0"+str(int(thersold()*100)), exist_ok=True)
    return "/data42/yingying/HydroDA/obs_patch/obs_patch0"+str(int(thersold()*100))
...
def outdir():
    if (val_mode()==0):
        ...
        return '/data50/yingying/HydroDA/out_patch'+ str(int(thersold()*100)) +'/'

def expout():
    if (val_mode()==0):
        return '../out/'
    else:
        return '../out_patch'+ str(int(thersold()*100)) +'/'
